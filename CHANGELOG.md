...
- A runnable example, `examples/runnable/home-page-layout`, which defaults to building a separate demonstration template that applies and destroys cleanly and changes nothing users see. Set `adopt_default_template = true` to manage the real home page once you have read the cleanup section of its README.
