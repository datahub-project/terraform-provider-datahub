...
Not auto-enumerated, even when NATIVE: assertion sub-shapes the typed resources cannot model (e.g. `SINCE_THE_LAST_CHECK`) and the FIELD / SCHEMA assertion types. Import those by URN if you need them.
