...
func NewServer(t *testing.T) *httptest.Server {
	...
	mux.HandleFunc("/openapi/v3/entity/glossarynode", s.handleGlossaryNodeWrite)
	mux.HandleFunc("/openapi/v3/entity/glossarynode/", s.handleGlossaryNodeItem)
	mux.HandleFunc("/openapi/v3/entity/glossaryterm", s.handleGlossaryTermWrite)
	...
	mux.HandleFunc("/test-control/drop-owners", s.handleDropOwners)
