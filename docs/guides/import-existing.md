...
Not auto-enumerated, even when NATIVE: the FIELD / DATA_SCHEMA assertion types and DATA_JOB_RUN freshness (which target a different entity). Import those by URN if you need them.
