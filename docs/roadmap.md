...
| `updateHelpLink` / `helpLink` | M/Q | MEDIUM | yes | Org-wide, `globalSettingsInfo.visual.helpLink`. Natural sibling to the shipped display-preferences resource; reuses the same singleton pattern. |
